...
const (
	DATA_FILE_PREFIX string = "data_file-"
)
...
func NewDataFile(dir string, idx string) (*DataFile, error) {
	// If the file doesn't exist, create it, or append to the file.
	path := filepath.Join(dir, DATA_FILE_PREFIX+idx)
